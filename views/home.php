            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="counter-one__single">
                    ...
                    <div class="counter-one__content-box">
                        ...
                        <p class="counter-one__text">Equipes expérimentées</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="counter-one__single counter-one__single-2">
                    ...
                    <div class="counter-one__content-box">
                        ...
                        <p class="counter-one__text">Prestations de qualité</p>
                    </div>
                </div>
            </div>
            <!--Counter One Single End-->
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="counter-one__single counter-one__single-3">
                    ...
                    <div class="counter-one__content-box">
                        ...
                        <p class="counter-one__text">Produits en vente</p>
                    </div>
                </div>
            </div>
            <!--Counter One Single End-->
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="counter-one__single counter-one__single-4">
                    ...
                    <div class="counter-one__content-box">
                        ...
                        <p class="counter-one__text">Satisfaction clients</p>
                    </div>
                </div>
            </div>
            <!--Counter One Single End-->
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6">
                    <div class="testimonial-one__left">
                        <div class="section-title text-left">
                            <h2 class="section-title__title">Leurs avis</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="item">
                    <div class="testimonial-one__single">
                        <div class="testimonial-one__icon-quote">
                            <img src="assets/images/icon/icon-quote.png" alt="quotes">
                        </div>
