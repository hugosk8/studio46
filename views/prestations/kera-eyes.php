<?php ob_start() ?>
<?php $metaDescription = "Dites adieu aux poils indésirables avec nos Kera'eyes professionnelles. Une peau lisse et soyeuse vous attend. Réservez votre séance dès maintenant : sourcils, visage, jambes, maillot.."?>
<?php $title = "Maison Kera | Kera'eyes" ?>
        ...
        <div class="row">
                ...
                <div class="services-details-two__left">
                    <div class="services-details-two__category">
                        <ul class="services-details-two__category-list list-unstyled">
                            ...
                            <li class="active"><a href="<?= URL ?>?p=kera-eyes">Kera'eyes<i class="fa fa-angle-right"></i></a></li>
            ...
            <div class="col-xl-8 col-lg-7">
                    <div class="services-details-two__right">
                        <h3 class="services-details-two__title-1 text-center">Kera'eyes</h3>
                        ...
                        <div class="inner" style="margin-top: 30px;">
                            <ul class="services-details-two__points list-unstyled">
                                <li class="mb-3">
                                    ...
                                    <div class="text">
                                        <p>Rehaussement cils + Teinture : 55€</p>
                                    </div>
                                </li>
                                <li class="mb-3">
                                    <div class="icon"><span class="fa fa-check"></span></div>
                                    <div class="text">
                                        <p>Brow lift + teinture + Épilation: 55€</p>
                                    </div>
                                </li>
                                <li class="mb-3">
                                    <div class="icon"><span class="fa fa-check"></span></div>
                                    <div class="text">
                                        <p>Teinture seule : 19€</p>
                                    </div>
                                </li>
                            </ul>
