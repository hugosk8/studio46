...
<section class="page-header">
    <div class="page-header__bg" style="background-image: url(assets/images/kera/breadcrumbs/bread-aquabike.webp);"></div>
    <div class="container">
                ...
                <div class="services-details-two__left">
                    <div class="services-details-two__category">
                        <ul class="services-details-two__category-list list-unstyled">
                            ...
                            <li class="active"><a href="<?= URL ?>?p=programme-kera-performance">Le programme Kera performance<i class="fa fa-angle-right"></i></a></li>
                    ...
                    <div class="services-details-two__help-line-img">
                        <img src="assets/images/kera/img-presta/news/aquabike.webp" height="" alt="photo d’une femme blonde qui fait de l’Programme kera performance">
                    </div>
