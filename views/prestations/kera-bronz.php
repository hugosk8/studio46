        ...
        <div class="row">
            <div class="col-xl-4 col-lg-5">
                <div class="services-details-two__left">
                    ...
                    <div class="services-details-two__help-line-img">
                        <img src="assets/images/studio46//epilation.webp" alt="photo de jambes d’une femme dans un institut de beauté qui se fait épiler avec de la cire rose ">
                    </div>
            ...
            <div class="col-xl-8 col-lg-7">
                    <div class="services-details-two__right">
                        <h3 class="services-details-two__title-1 text-center">Kera bronz'</h3>
                        ...
                        <div class="inner" style="margin-top: 30px;">
                            <ul class="services-details-two__points list-unstyled">
                                <li class="mb-3">
                                    ...
                                    <div class="text">
                                        <p>Séance UV 15min : 8€</p>
                                    </div>
                                </li>
                                <li class="mb-3">
                                    <div class="icon"><span class="fa fa-check"></span></div>
                                    <div class="text">
                                        <p>Séance UV 20min : 10€</p>
                                    </div>
                                </li>
                                <li class="mb-3">
                                    <div class="icon"><span class="fa fa-check"></span></div>
                                    <div class="text">
                                        <p>Bronzage sans UV : 15€</p>
                                    </div>
                                </li>
                            </ul>
