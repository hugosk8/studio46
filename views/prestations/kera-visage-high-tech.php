...
<section class="page-header">
    <div class="page-header__bg" style="background-image: url(assets/images/kera/breadcrumbs/extension-de-cils.webp);"></div>
    <div class="container">
                ...
                <div class="services-details-two__left">
                    <div class="services-details-two__category">
                        <ul class="services-details-two__category-list list-unstyled">
                            ...
                            <li class="active"><a href="<?= URL ?>?p=kera-visage-high-tech">Kera visage high tech<i class="fa fa-angle-right"></i></a></li>
                    ...
                    <div class="services-details-two__help-line">
                        <div class="services-details-two__help-line-img">
                            <img src="assets/images/kera/img-presta/soins-mains-pieds.webp" alt="photo d’une main qui met de la crème sur un pied">
                        </div>
