        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
                    <div class="services-details-two__right">
                        <h3 class="services-details-two__title-1 text-center">Kera mani</h3>
                        ...
                        <div class="inner" style="margin-top: 30px;">
                            <ul class="services-details-two__points list-unstyled">
                                <li class="mb-3">
                                    ...
                                    <div class="text">
                                        <p>Manucure simple (limage et cuticules) 25€<br><span class="underlined">option :</span> semi permanent +10€</p>
                                    </div>
                                </li>
                                <li class="mb-3">
                                    <div class="icon"><span class="fa fa-check"></span></div>
                                    <div class="text">
                                        <p>Manucure complète (gommage + modelage) 40€<br><span class="underlined">option :</span> semi permanent +10€</p>
                                    </div>
                                </li>
                                <li class="mb-3">
                                    <div class="icon"><span class="fa fa-check"></span></div>
                                    <div class="text">
                                        <p>Manucure complète avec paraffine 50€<br><span class="underlined">option :</span> semi permanent +10€</p>
                                    </div>
                                </li>
                                <li class="mb-3">
                                    <div class="icon"><span class="fa fa-check"></span></div>
                                    <div class="text">
                                        <p>Dépose avec soin de l’ongle : 20€<br>seulement 10€ pour dépose suivie de pose</p>
                                    </div>
                                </li>
                            </ul>
