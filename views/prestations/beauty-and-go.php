...
<section class="page-header">
    <div class="page-header__bg" style="background-image: url(assets/images/kera/breadcrumbs/maquillage.webp);"></div>
    <div class="container">
                ...
                <div class="services-details-two__left">
                    <div class="services-details-two__category">
                        <ul class="services-details-two__category-list list-unstyled">
                            ...
                            <li class="active"><a href="<?= URL ?>?p=beauty-and-go">Beauty and go<i class="fa fa-angle-right"></i></a></li>
                        </ul>
                    </div>
                    <div class="services-details-two__help-line">
                        <div class="services-details-two__help-line-img">
                            <img src="assets/images/kera/img-presta/maquillage.webp" alt="photo d’une femme qui se fait maquiller avec un pinceau délicatement les yeux">
                        </div>
